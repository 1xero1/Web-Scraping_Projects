...
BaseStatus = BasePage.status_code #check if the website working status
if BaseStatus==200:
    print("Success! The Main page is working")

BasePageSoup = BeautifulSoup(BasePage.content, 'html.parser')#get the page content via 'html.parser'
...
LangSelect=lst[4:16] # List for language selection
CountriesURLsList=lst[17:-25] #List of Countries (destinatiopn URLs)
#CountriesURLsList
